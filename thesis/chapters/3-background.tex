...
by adding a second ligation-step (see \secref{sec:ligation} and \figref{fig:cct}
...
% For inverse-PCR knowledge about both interacting chromosomal regions is not
% needed, thus results are highly reproducible for close regions.
...
of possible visualizations can be seen in \figref{fig:HiCExplorer}. HiCExplorer
