...
\todo{put stuff in lowercase (Chromosome Conformation Capture / Technologies}

\todo{remove subsections and combine them}

\todo{introduce 3-C, 4-C, 5-C, then Hi-C, also add to reference}

\todo{3-C, Dekker 2012: one vs one}

\todo{4-C, Simonis 2006, Zhao 2006}

\todo{5-C, Dostie 2006}

\draft{more storytelling}

\draft{rewrite this part}
...
\todo{Restriction encymes: \cite{liebermann2009comprehensive}}
