...
\todo{python having a global interpreter lock for its multiprocessing module, needing to copy the RAM, sometimes numpy is using paralellization, dependent on version}
...
\extend{update after results, compare requirements}
