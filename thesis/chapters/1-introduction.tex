...
\extend{not however so many times!}
...
\section{Concrete Task definition}\label{sec:task}

\todo{remove ball of wool}
% chapters/1-introduction.tex:close to that of a ball of wool. Obviously, many points of contacts of the DNA
% chapters/1-introduction.tex:wire with itself, called DNA interactions, exist in this ``ball of wool'' and
% chapters/3-background.tex:outside (highest structural layer), DNA looks like a big ball of wool. With the
% chapters/3-background.tex:The next step is cutting the DNA, currently more similar to a ball of wool,

\todo{Bilder: Image dapted from anstatt Image from ...}

\todo{Prüfungsamt abklären: Digitale Kopie? -> AJ Müller}
