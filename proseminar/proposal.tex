...
% der erste Satz ist echt ganz schön sperrig
...
% der Verständlichkeit würde es auch hier gut tun, wenn du die Definitionen
% in mehrere Sätze aufteilen würdest
...
eben nicht.
% Vielleicht noch mehr auf das Halteproblem eingehen. Warum ist das so
% interessant? Später wird das ja wieder zentral und ich vermute, 
% dass das nicht allen ein Begriff sein wird.
...
% Warum würde sie nicht halten? Eine Begründung würde, auch wenn es offensichtlich ist,
% sicher nicht schaden.


\section{Unendlichkeit}
% Warum geht es jetzt auf einmal um Unendlichkeit? Kleine Überleitung würde
...
Superturingmaschinen klingen jetzt erstmal total super, und das sind sie auch. %lol
